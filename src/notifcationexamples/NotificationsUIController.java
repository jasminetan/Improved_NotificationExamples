...
public class NotificationsUIController implements Initializable, Notifiable {
    ...
    public void notify(String message) {
        ...
        if (task1.getThreadState() == ThreadState.RUNNING){
            button1.setText("End Task 1");
        }
        if (task1.getThreadState() == ThreadState.STOPPED){
            button1.setText("Start Task 1");
        }
    }
    ...
    public void startTask2(ActionEvent event) {
        ...
        if (task2 == null) {
            ...
            task2.setOnNotification((String message) -> {
                textArea.appendText(message + "\n");
                if (task2.getThreadState() == ThreadState.RUNNING){
                    button2.setText("End Task 2");
                }
                if (task2.getThreadState() == ThreadState.STOPPED){
    ...
    public void startTask3(ActionEvent event) {
        ...
        if (task3 == null) {
            ...
            task3.addPropertyChangeListener((PropertyChangeEvent evt) -> {
                ...
                if (task3.getThreadState() == ThreadState.RUNNING){
                    button3.setText("End Task 3");
                }
                if (task3.getThreadState() == ThreadState.STOPPED){
